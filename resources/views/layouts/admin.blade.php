    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                @include('admin.partials.category_menu')
                <li>
                    <a href="/admin/orders">
...
<!-- Bootstrap Core Js -->
<script src="{{ asset('adminpanel/plugins/bootstrap/js/bootstrap.js') }}"></script>

<!-- Select Plugin Js -->
<script src="{{ asset('adminpanel/plugins/bootstrap-select/js/bootstrap-select.js') }}"></script>

<!-- Slimscroll Plugin Js -->
<script src="{{ asset('adminpanel/plugins/jquery-slimscroll/jquery.slimscroll.js') }}"></script>

<!-- Waves Effect Plugin Js -->
<script src="{{ asset('adminpanel/plugins/node-waves/waves.js') }}"></script>

<!-- Jquery CountTo Plugin Js -->
<script src="{{ asset('adminpanel/plugins/jquery-countto/jquery.countTo.js') }}"></script>

<!-- Morris Plugin Js -->
<script src="{{ asset('adminpanel/plugins/raphael/raphael.min.js') }}"></script>
<script src="{{ asset('adminpanel/plugins/morrisjs/morris.js') }}"></script>

<!-- ChartJs -->
<script src="{{ asset('adminpanel/plugins/chartjs/Chart.bundle.js') }}"></script>

<!-- Flot Charts Plugin Js -->
<script src="{{ asset('adminpanel/plugins/flot-charts/jquery.flot.js') }}"></script>
<script src="{{ asset('adminpanel/plugins/flot-charts/jquery.flot.resize.js') }}"></script>
<script src="{{ asset('adminpanel/plugins/flot-charts/jquery.flot.pie.js') }}"></script>
<script src="{{ asset('adminpanel/plugins/flot-charts/jquery.flot.categories.js') }}"></script>
<script src="{{ asset('adminpanel/plugins/flot-charts/jquery.flot.time.js') }}"></script>

<!-- Sparkline Chart Plugin Js -->
<script src="{{ asset('adminpanel/plugins/jquery-sparkline/jquery.sparkline.js') }}"></script>

<!-- Custom Js -->
<script src="{{ asset('adminpanel/js/admin.js') }}"></script>

@yield('specificJS')

{{--<script src="{{ asset('adminpanel/js/pages/index.js') }}"></script>--}}
